...
public class DatosPrimitivos {
	...
	public static void main(String[] args) {
		...
		System.out.println(
				"'char' es un tipo de dato primitivo que representa un solo carácter en Unicode. Los valores char se escriben entre comillas simples (' '), y solo pueden contener un carácter a la vez. Ejemplo: char letra="
						+ letra + ";");
		System.out.println(
				"'String' se escriben entre comillas dobles (\" \"), y pueden contener uno o más caracteres. Ejemplo: palabra="
						+ palabra + ";");
		// BOOLEANO
